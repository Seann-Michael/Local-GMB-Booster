...
import { PLATFORM_DISPLAY_NAMES, OAuthPopupMessage } from "../../types/oauth";
      ...
      case "success":
        return (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">You can close this window</p>
...
export class OAuthPopupManager {
  ...
  private callbacks: Map<string, (message: OAuthPopupMessage) => void> =
    new Map();
