...
const ZoomControlCard: React.FC<ZoomControlCardProps> = ({
  ...
  <div className="bg-blue-50/30 border border-blue-200 rounded-lg p-4">
    <div className="flex items-center gap-2 mb-3">
      ...
      <h3 className="text-sm font-medium text-gray-900">Map Zoom Control</h3>
    </div>
    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          >
            {isManualZoomMode ? "Manual Control" : "Auto Adjust"}
          </button>
        </div>
        {isManualZoomMode && (
      ...
      {isManualZoomMode && (
        <div className="space-y-3 p-3 bg-white rounded-lg border border-blue-200">
          ...
          <div className="text-xs text-gray-500 text-center pt-1">
            0% = Wide area view • 50% = Balanced view • 100% = Close detail view
          </div>
        </div>
      )}
