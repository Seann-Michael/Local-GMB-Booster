      ...
      submenuItems: [
        {
          id: "one-time-scan",
          label: "One Time Scan",
          href: "/admin/audits/one-time-scan",
          active: location.pathname === "/admin/audits/one-time-scan",
        },
        {
          id: "recurring-scans",
          label: "Recurring Scans",
          href: "/admin/audits/recurring-scans",
          active: location.pathname === "/admin/audits/recurring-scans",
        },
        {
          id: "scan-history",
          label: "Scan History",
