...
const mockGeoScanData: GeoGridScanData = {
  ...
  businessLocation: { lat: 40.7589, lng: -73.9851 },
...
export default function AuditReportSimpleWorking() {
        ...
        <div className="p-6 max-w-6xl mx-auto">
          <Card>
            <CardContent className="text-center py-12">
              ...
              <Button onClick={() => navigate("/admin/maps/scan-history")}>
