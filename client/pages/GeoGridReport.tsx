        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <Select 
                  value={selectedCompetitor || "business"} 
                  onValueChange={(value) => setSelectedCompetitor(value === "business" ? null : value)}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                    ...
                    {(() => {
                      ...
                      return competitor ? (
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-gray-600">{competitor.address}</p>
                          {competitor.website && (
                            <p className="text-xs text-blue-600">{competitor.website}</p>
                          )}
                          {competitor.phone && (
                            <p className="text-xs text-gray-600">{competitor.phone}</p>
                          )}
                        </div>
                      ) : null;
                    })()}
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm">Total Waypoints</span>
                    <Badge variant="outline">{analytics.total}</Badge>
                  </div>
                  
                  <div className="flex justify-between items-center">
                    <span className="text-sm">Ranked Waypoints</span>
                    <Badge variant="outline">{analytics.ranked}</Badge>
                  </div>
                  
                  <div className="flex justify-between items-center">
                    <span className="text-sm">Average Position</span>
                    <Badge variant="default">{analytics.average}</Badge>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">Rank 1-3</span>
                      </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">Rank 4-9</span>
                      </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">Rank 10-15</span>
                      </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">Rank 16-20+</span>
                      </div>
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <p className="font-medium text-sm">{competitor.name}</p>
                          <p className="text-xs text-gray-600 mt-1">{competitor.address}</p>
                ...
                <CardTitle className="flex items-center gap-2">
                  ...
                  {selectedCompetitor && (
                    <Badge variant="secondary" className="ml-auto">
                      Showing: {scanResult.competitors.find(c => c.id === selectedCompetitor)?.name}
                    </Badge>
                  )}
                </CardTitle>
              </CardHeader>
