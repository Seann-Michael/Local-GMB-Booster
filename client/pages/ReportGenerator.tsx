...
// Report data is fetched from real backend endpoints when they are available.
...
export default function ReportGenerator() {
  ...
  const runReport = async () => {
    ...
    setLoading(true);
    try {
      // Report data comes from real backend queries.
      // Currently no backend endpoint is wired — show empty results.
      setReportData([]);
    } finally {
      setCurrentPage(1);
      setLoading(false);
