...
export default function AppPages() {
  const modules: ModuleSection[] = [
    ...
    },
    {
      ...
      description: "Job creation, editing, and management",
      icon: FolderOpen,
      pages: [
        {
          name: "Add Job",
        ...
        },
        {
          name: "Job Detail",
          path: "/job/:id",
          description: "View job details (requires ID)",
          icon: Eye,
        },
        {
          name: "Edit Job",
          path: "/job/:id/edit",
          description: "Edit job (requires ID)",
          icon: Edit,
        },
        {
          name: "Public Job",
          path: "/public/job/:id",
          description: "Public job view (requires ID)",
          icon: Globe,
        },
      ],
    },
    ...
    },
    {
      ...
      pages: [
        {
          name: "Agency Jobs",
          path: "/agency/admin/jobs",
          description: "Agency job dashboard",
          icon: FolderOpen,
        },
        {
          name: "Create Agency Job",
          path: "/agency/admin/jobs/create",
          description: "Create agency job",
          icon: Plus,
        },
        {
          name: "Agency Job Detail",
          path: "/agency/admin/jobs/:id",
          description: "Agency job details",
          icon: Eye,
        },
        {
          name: "Edit Agency Job",
          path: "/agency/admin/jobs/:id/edit",
          description: "Edit agency job",
          icon: Edit,
        },
      ],
    },
